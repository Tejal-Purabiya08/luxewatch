      ...
      <div className="login-container">
        ...
        <div className="brand-section">
          <div className="brand-content">
            ...
            <h1 className="brand-title">Join Our World</h1>
            <p className="brand-subtitle">Create your account and discover the world of luxury timepieces crafted for those who appreciate excellence</p>
            ...
            <form onSubmit={handleRegister}>
              ...
              <div className="password-strength">
                <div className="strength-bars">
                  <div className={`bar ${formData.password.length >= 1 ? 'active weak' : ''}`}></div>
                  <div className={`bar ${formData.password.length >= 4 ? 'active medium' : ''}`}></div>
                  <div className={`bar ${formData.password.length >= 8 ? 'active strong' : ''}`}></div>
                </div>
                <span className="strength-text">
                  {formData.password.length === 0 && 'Enter a password'}
                  {formData.password.length >= 1 && formData.password.length < 4 && 'Weak'}
